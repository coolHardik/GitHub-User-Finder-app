...
function init() {
  ...
  console.log("gii",prefersDarkMode);
  console.log("hii",darkMode);
  ...
  //by default, Hardik ki info show krre h UI pr
  getUserData(url + "coolHardik");
}
